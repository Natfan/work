...
## PVI - Importance of the User Accptance process
...
The second step in this process is to hand the devices back to the customer. Given that I work as IT support within UTC Reading, this was reliatively easy as I did not have to move any physical devices per se, as all of the hardware was untouched. The software was installed via group policy, so I only needed to show the customer one of the machines as they are all completely identical.

The third and 

`configuration meets customers needs`
