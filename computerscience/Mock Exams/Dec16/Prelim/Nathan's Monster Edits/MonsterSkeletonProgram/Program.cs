...
namespace MonsterSkeletonProgram {
    class Program {
            ...
            public void Play() {
                ...
                do {
                    ...
                    if (MoveDirection != 'M') {
                        ...
                        if (!Monster.GetAwake() && !FlaskFound && !Eaten && ((Player.CheckIfSameCell(Trap1.GetPosition())
                        && !Trap1.GetTriggered()) || (Player.CheckIfSameCell(Trap2.GetPosition()) && !Trap2.GetTriggered()))) {
